...
public class CricketMatchDataBean {
    ...
    public void setLive_time_unix(int live_time_unix){
        this.live_time_unix = live_time_unix;
    }
    public int getLive_time_unix(){
    ...
    public String getHome_display_score(){
        return this.home_display_score;
    }
    ...
    public String getAway_display_score(){
        return this.away_display_score;
    }
