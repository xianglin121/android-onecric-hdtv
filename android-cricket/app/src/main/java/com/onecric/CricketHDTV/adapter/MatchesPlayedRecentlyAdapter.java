 ...
 * 时间：2022/8/27
 */
public class MatchesPlayedRecentlyAdapter extends BaseQuickAdapter<CricketMatchBean, BaseViewHolder> {
    public MatchesPlayedRecentlyAdapter(int layoutResId, @Nullable List<CricketMatchBean> data) {
