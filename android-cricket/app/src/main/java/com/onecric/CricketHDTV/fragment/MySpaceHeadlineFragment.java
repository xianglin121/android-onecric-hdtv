 ...
 * 时间：2022/1/10
 */
public class MySpaceHeadlineFragment extends BaseFragment implements View.OnClickListener {
    public static MySpaceHeadlineFragment newInstance(int uid) {
        MySpaceHeadlineFragment fragment = new MySpaceHeadlineFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_my_space_headline;
    }
    ...
    protected void initData() {
        //初始化viewpager
        mViewList.add(MySpaceHeadlineOneFragment.newInstance(mUid));
        mViewList.add(MySpaceHeadlineTwoFragment.newInstance(mUid));
        mViewList.add(ThemeCollectionHeadlineFragment.newInstance(mUid));
