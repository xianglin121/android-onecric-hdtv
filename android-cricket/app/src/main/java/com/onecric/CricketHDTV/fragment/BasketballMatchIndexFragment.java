...
import com.onecric.CricketHDTV.model.BasketballIndexOneBean;
import com.onecric.CricketHDTV.model.BasketballIndexTwoBean;
import com.onecric.CricketHDTV.presenter.match.BasketballMatchIndexPresenter;
...
public class BasketballMatchIndexFragment extends MvpFragment<BasketballMatchIndexPresenter> implements BasketballMatchIndexView, View.OnClickListener {
    ...
    public static BasketballMatchIndexFragment newInstance(int id) {
        BasketballMatchIndexFragment fragment = new BasketballMatchIndexFragment();
    ...
    @Override
    protected BasketballMatchIndexPresenter createPresenter() {
    ...
    protected void initData() {
        ...
        mViewList.add(BasketballMatchIndexInnerFragment.newInstance(BasketballMatchIndexInnerFragment.TYPE_RANGQIU, mId));
        mViewList.add(BasketballMatchIndexInnerFragment.newInstance(BasketballMatchIndexInnerFragment.TYPE_OUPEI, mId));
        mViewList.add(BasketballMatchIndexInnerFragment.newInstance(BasketballMatchIndexInnerFragment.TYPE_DAXIAOQIU, mId));
    ...
    public void getDataSuccess(BasketballIndexBean indexBean) {
        if (indexBean != null) {
            ...
            ((BasketballMatchIndexInnerFragment)mViewList.get(0)).setData(asia, indexBean.getCompensation());
            //欧赔
            ...
            ((BasketballMatchIndexInnerFragment)mViewList.get(1)).setData(eu, indexBean.getCompensation());
            //大小球
            ...
            ((BasketballMatchIndexInnerFragment)mViewList.get(2)).setData(bs, indexBean.getCompensation());
        }
    }
