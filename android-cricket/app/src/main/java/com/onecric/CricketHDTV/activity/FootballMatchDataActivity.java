...
import com.onecric.CricketHDTV.event.UpdateMatchDataFollowEvent;
import com.onecric.CricketHDTV.fragment.FootballDataBestFragment;
import com.onecric.CricketHDTV.fragment.FootballDataRankingFragment;
import com.onecric.CricketHDTV.fragment.FootballDataScheduleFragment;
import com.onecric.CricketHDTV.fragment.FootballDataStatusFragment;
...
import com.onecric.CricketHDTV.presenter.match.FootballMatchDataPresenter;
...
public class FootballMatchDataActivity extends MvpActivity<FootballMatchDataPresenter> implements FootballMatchDataView, View.OnClickListener {
    ...
    public static void forward(Context context, int id) {
        Intent intent = new Intent(context, FootballMatchDataActivity.class);
    ...
    @Override
    protected FootballMatchDataPresenter createPresenter() {
    ...
    protected void initData() {
        ...
        mTitles.add("积分");
        mTitles.add("最佳");
        mViewList.add(FootballDataStatusFragment.newInstance());
        mViewList.add(FootballDataScheduleFragment.newInstance());
        mViewList.add(FootballDataRankingFragment.newInstance());
        mViewList.add(FootballDataBestFragment.newInstance());
        initViewPager();

        mvpPresenter.getDetail(mId, 0, 0, 0);
    }
    ...
    @Override
    public void getDetailSuccess(List<DataSeasonBean> seasonList, DataInfoBean info, FootballDataStatusBean statusBean) {
        ...
        ((FootballDataStatusFragment)mViewList.get(0)).setData(statusBean);
        ((FootballDataScheduleFragment)mViewList.get(1)).setData(mId, mSeasonId);
        ((FootballDataRankingFragment)mViewList.get(2)).getList(mSeasonId);
        ((FootballDataBestFragment)mViewList.get(3)).getList(mSeasonId);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_follow:
                ...
                EventBus.getDefault().post(new UpdateMatchDataFollowEvent(mId, 0));
                break;
            case R.id.tv_year:
