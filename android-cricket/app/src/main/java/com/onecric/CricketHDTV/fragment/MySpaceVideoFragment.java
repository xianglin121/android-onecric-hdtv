 ...
 * 时间：2022/1/10
 */
public class MySpaceVideoFragment extends BaseFragment implements View.OnClickListener {
    public static MySpaceVideoFragment newInstance(int uid) {
        MySpaceVideoFragment fragment = new MySpaceVideoFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_my_space_video;
    }
    ...
    protected void initData() {
        //初始化viewpager
        mViewList.add(MySpaceVideoOneFragment.newInstance(mUid));
        mViewList.add(MySpaceVideoTwoFragment.newInstance(mUid));
        mViewList.add(MySpaceVideoThreeFragment.newInstance(mUid));
