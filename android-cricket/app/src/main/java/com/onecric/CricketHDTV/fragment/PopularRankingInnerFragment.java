...
import com.onecric.CricketHDTV.adapter.RankingAdapter;
import com.onecric.CricketHDTV.model.RankingUserBean;
import com.onecric.CricketHDTV.presenter.live.PopularRankingPresenter;
...
public class PopularRankingInnerFragment extends MvpFragment<PopularRankingPresenter> implements PopularRankingView, View.OnClickListener {
    public static PopularRankingInnerFragment newInstance(int type) {
        PopularRankingInnerFragment fragment = new PopularRankingInnerFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_popular_ranking_inner;
    }

    @Override
    protected PopularRankingPresenter createPresenter() {
        return new PopularRankingPresenter(this);
    }
    ...
    protected void initUI() {
        ...
        iv_level_two = findViewById(R.id.iv_level_two);
        ...
        iv_level_one = findViewById(R.id.iv_level_one);
        ...
        iv_level_three = findViewById(R.id.iv_level_three);
    ...
    protected void initData() {
        ...
        mAdapter = new RankingAdapter(R.layout.item_popular_ranking, new ArrayList<>());
