...
import com.onecric.CricketHDTV.adapter.PhonePrefixAdapter;
...
public class RegisterOldActivity extends MvpActivity<RegisterPresenter> implements RegisterView, View.OnClickListener {

    public static void forward(Context context) {
        Intent intent = new Intent(context, RegisterOldActivity.class);
                    ...
                    if (jsonObject.getIntValue("ret") == 0) {
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                mvpPresenter.register(prefix + "-" + phone, et_code.getText().toString(), et_pwd_one.getText().toString());
                            }
                        });
                    }
                }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_toggle_two:
                ...
                et_pwd_two.setSelection(et_pwd_one.getText().toString().length());
                //解决英文时hint字体会发现变化
