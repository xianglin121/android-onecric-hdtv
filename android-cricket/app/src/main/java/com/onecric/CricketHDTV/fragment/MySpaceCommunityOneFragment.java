...
import com.onecric.CricketHDTV.presenter.user.MySpaceCommunityOnePresenter;
import com.onecric.CricketHDTV.view.MvpFragment;
import com.onecric.CricketHDTV.view.user.MySpaceCommunityOneView;
...
public class MySpaceCommunityOneFragment extends MvpFragment<MySpaceCommunityOnePresenter> implements MySpaceCommunityOneView {

    public static MySpaceCommunityOneFragment newInstance(int uid) {
        MySpaceCommunityOneFragment fragment = new MySpaceCommunityOneFragment();
    ...
    @Override
    protected MySpaceCommunityOnePresenter createPresenter() {
        return new MySpaceCommunityOnePresenter(this);
    }
