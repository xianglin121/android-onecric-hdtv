 ...
 * 时间：2021/9/14
 */
public class ThemeCollectionCommunityAdapter extends BaseQuickAdapter<CommunityBean, BaseViewHolder> {
    public ThemeCollectionCommunityAdapter(int layoutResId, @Nullable List<CommunityBean> data) {
...
//        helper.addOnClickListener(R.id.ll_comment);
        ...
        helper.getView(R.id.iv_collect).setSelected(true);
