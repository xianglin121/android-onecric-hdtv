 ...
 * 时间：2021/10/23
 */
public class LiveMovingCommentAdapter extends BaseQuickAdapter<MovingBean, BaseViewHolder> {
    public LiveMovingCommentAdapter(int layoutResId, @Nullable List<MovingBean> data) {
