 ...
 * 时间：2021/10/23
 */
public class VideoCommentAdapter extends BaseQuickAdapter<CommunityBean, BaseViewHolder> {
    public VideoCommentAdapter(int layoutResId, @Nullable List<CommunityBean> data) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, CommunityBean item) {
        ...
        helper.setText(R.id.tv_time, TextUtils.isEmpty(item.getAddtime())?"":item.getAddtime());
    }
