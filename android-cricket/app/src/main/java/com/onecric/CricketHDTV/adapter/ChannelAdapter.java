        ...
        switch (helper.getItemViewType()) {
            ...
            case Channel.TYPE_MY_CHANNEL:
                ...
                if (channel.selected == 1) {
                    helper.setTextColor(R.id.tvChannel, mContext.getResources().getColor(R.color.c_A9A9A9));
                }else {
                    helper.setTextColor(R.id.tvChannel, mContext.getResources().getColor(R.color.c_333333));
                }
...
//                            GlobalParams.mRemovedChannels.add(channel);
                ...
                helper.setText(R.id.tvChannel, channel.short_name_zh);
                break;
