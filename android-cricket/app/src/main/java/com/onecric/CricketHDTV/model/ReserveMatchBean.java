 ...
 * 时间：2021/12/15
 */
public class ReserveMatchBean implements MultiItemEntity {
    ...
    private List<LiveUserBean> anchorList;
    ...
    public List<LiveUserBean> getAnchorList() {
        return anchorList;
    }

    public void setAnchorList(List<LiveUserBean> anchorList) {
