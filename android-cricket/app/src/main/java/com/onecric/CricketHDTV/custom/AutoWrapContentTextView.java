...
public class AutoWrapContentTextView extends View {
    ...
    public AutoWrapContentTextView(Context context) {
        super(context);
    }

    public AutoWrapContentTextView(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs);
    }

    public AutoWrapContentTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public AutoWrapContentTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
